...
responses = (
	(r'Teamwork (.*)',
	  ("Talk about a time when you had to work closely with someone whose personality was very different from yours. How did you handle it %1?",
	   ...
	   "We all make mistakes we wish we could take back. Tell me about a time you wish youd handled a situation differently with a colleague and how you handled it %1?",
