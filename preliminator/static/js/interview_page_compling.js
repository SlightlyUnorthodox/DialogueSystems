const DIALOG_SYS_API = '/dialg/process_ajax';   //TO-DO: use ACTUAL dialog system API
...
function do_initial_messages(){
   setTimeout(function(){
      add_chat_entry(
         "Welcome to the Compling Chatbot, please click 'enter' or speak in to the mic to begin.",
         {'source':'system'}
      );
   },250);
}
